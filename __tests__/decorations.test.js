...
describe('details', () => {
  test('details WalkInsWelcome=Y ADACompliant=N AppointmentsAvailable=Y', () => {
    ...
    expect(div.html()).toBe('<div class="detail"><div><strong>ADA Compliant: </strong>No</div><div><strong>Walk-ins Welcome: </strong>Yes</div><div><strong>Appointment Available: </strong>Yes</div><div class="op-hours"><table><thead><tr><th>Day</th><th>Hours of Operation</th></tr></thead><tbody><tr><td class="day">Monday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Tuesday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Wednesday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Thursday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Friday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Saturday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Sunday</td><td class="hrs notranslate">now - later</td></tr></tbody></table></div><i>Tests can be used on people 2 years and older.</i><div>......</div></div>')
  })
  ...
  test('details WalkInsWelcome=N ADACompliant=Y AppointmentsAvailable=N', () => {
    ...
    div.html(feature.detailsHtml())
    expect(div.html()).toBe('<div class="detail"><div><strong>ADA Compliant: </strong>Yes</div><div><strong>Walk-ins Welcome: </strong>No</div><div><strong>Appointment Available: </strong>No</div><div class="op-hours"><table><thead><tr><th>Day</th><th>Hours of Operation</th></tr></thead><tbody><tr><td class="day">Monday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Tuesday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Wednesday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Thursday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Friday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Saturday</td><td class="hrs notranslate">now - later</td></tr><tr><td class="day">Sunday</td><td class="hrs notranslate">now - later</td></tr></tbody></table></div><i>Tests can be used on people 2 years and older.</i><div>......</div></div>')
  })
